...
public class HlavniOkno extends JFrame {
    ...
    private void initComponents() {
        ...
        //---- labLuke ----
        labLuke.setIcon(new ImageIcon(getClass().getResource("/com/example/r2d2/luke.png")));
        ...
        //---- labTroop1 ----
        labTroop1.setIcon(new ImageIcon(getClass().getResource("/com/example/r2d2/troop.png")));
        contentPane.add(labTroop1);
        labTroop1.setBounds(new Rectangle(new Point(25, 130), labTroop1.getPreferredSize()));

        //---- labTroop2 ----
        labTroop2.setIcon(new ImageIcon(getClass().getResource("/com/example/r2d2/troop.png")));
        contentPane.add(labTroop2);
        labTroop2.setBounds(480, 210, 37, 70);

        //---- labTroop3 ----
        labTroop3.setIcon(new ImageIcon(getClass().getResource("/com/example/r2d2/troop.png")));
        contentPane.add(labTroop3);
        labTroop3.setBounds(385, 285, 37, 70);

        //---- labLeia ----
        labLeia.setIcon(new ImageIcon(getClass().getResource("/com/example/r2d2/leia.png")));
        contentPane.add(labLeia);
        labLeia.setBounds(new Rectangle(new Point(380, 425), labLeia.getPreferredSize()));

        //---- labObivan ----
        labObivan.setIcon(new ImageIcon(getClass().getResource("/com/example/r2d2/obivanKenobi.png")));
